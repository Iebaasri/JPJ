<?php
include ('config.php');
$ud_nama_penuh=$POST['ud_nama_penuh'];
...
nama_penuh='$ud_nama_penuh',tempat_lahir='$ud_tempat_lahir',jantina='$ud_jantina',jenis_lesen='$ud_jenis_lesen' WHERE no_ic='$ud_no_ic'";
mysql_query($query);
