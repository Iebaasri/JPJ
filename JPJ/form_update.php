...
while ($i<$num) {
	...
	<td><input name="ud_tempat_lahir" type="text" value="<?php echo $tempat_lahir;?>" maxlength="100"/></td>
	</tr>
	<tr>
	<th scope="row">Jantina:</th>
	<td><input name="ud_jantina" type="text" value="<?php echo $jantina;?>"/></td>
	</tr>
	<tr>
	<th scope="row">Jenis Lesen:</th>
	<td><input name="ud_jenis_lesen" type="text" value="<?php echo $jenis_lesen;?>"/></td>
	</tr>
	</table>
	<br>
